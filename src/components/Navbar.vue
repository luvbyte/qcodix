<template>
  <div class="h-12 flex justify-between items-center bg-primary text-primary-content glass px-2">
...
<script setup>
  const emit = defineEmits(["close", "showSettings", "showSideBar"]);
</script>
